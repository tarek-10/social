...
router.post("/register", upload.array('image', 5), validationResult(registerUser), userRegisteration);
//end
...
router.put("/user/update/:id", validationResult(updateUser), isAuthorized(UPDATE_USERS), updatingUsers)
//end

//delete user
const deleteingUsers = require("../controller/deleteingUser");
router.delete("/user/delete/:id", validationResult(deleteUsers), isAuthorized(DELETE_USERS), deleteingUsers)
//end
...
router.put("/follow/:id", validationResult(followUsers), isAuthorized(FOLLOW_USER), followingUsers)
//end

//unfollow user
const unfollowusers = require("../controller/unfollowUsers.controller");
router.put("/unfollow/:id", validationResult(unfollowUser), isAuthorized(UNFOLLOW_USER), unfollowusers)
//end
